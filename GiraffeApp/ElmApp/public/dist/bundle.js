...
/* harmony export (immutable) */ __webpack_exports__["onSignIn"] = onSignIn;
const Elm = __webpack_require__(2);
const elmDiv = document.getElementById('elm-area');
const app = Elm.Main.embed(elmDiv, "http://localhost:55715/api/v1");
...
var _user$project$Model$formatPercent = _ggb$numeral_elm$Numeral$format('0 %');
var _user$project$Model$formatTime = function (_p0) {
	return A2(
		...
		A2(
			...
			1000.0,
			_elm_community$elm_time$Time_DateTime$toTimestamp(_p0)));
};
var _user$project$Model$duration = function (logEntry) {
	return _elm_community$elm_time$Time_DateTime$toTimestamp(logEntry.end) - _elm_community$elm_time$Time_DateTime$toTimestamp(logEntry.start);
};
var _user$project$Model$loggedTime = function (activity) {
	return _elm_lang$core$List$sum(
		A2(_elm_lang$core$List$map, _user$project$Model$duration, activity.log));
};
var _user$project$Model$activityGoal = function (activity) {
	return (_elm_lang$core$Basics$toFloat(activity.minutesPerWeek) * 60.0) * 1000.0;
};
var _user$project$Model$remaining = function (activity) {
	return _elm_community$elm_time$Time_DateTime$fromTimestamp(
		_user$project$Model$activityGoal(activity) - _user$project$Model$loggedTime(activity));
};
var _user$project$Model$remainingString = function (_p1) {
	return _user$project$Model$formatTime(
		_user$project$Model$remaining(_p1));
};
var _user$project$Model$onScheduleRatio = function (activity) {
	return _user$project$Model$loggedTime(activity) / _user$project$Model$activityGoal(activity);
};
var _user$project$Model$onScheduleSort = F2(
	function (a, b) {
		return A2(
			_elm_lang$core$Basics$compare,
			_user$project$Model$onScheduleRatio(a),
			_user$project$Model$onScheduleRatio(b));
	});
var _user$project$Model$topActivities = function (_p2) {
	return A2(
		_elm_lang$core$List$take,
		3,
		A2(_elm_lang$core$List$sortWith, _user$project$Model$onScheduleSort, _p2));
};
var _user$project$Model$onScheduleRatioString = function (_p3) {
	return _user$project$Model$formatPercent(
		_user$project$Model$onScheduleRatio(_p3));
};
var _user$project$Model$AuthenticatedData = F3(
	function (a, b, c) {
		return {name: a, image_url: b, id_token: c};
	});
var _user$project$Model$LogEntry = F2(
	function (a, b) {
		return {start: a, end: b};
	});
var _user$project$Model$Activity = F3(
	function (a, b, c) {
		return {name: a, minutesPerWeek: b, log: c};
	});
var _user$project$Model$initActivity1 = function () {
	var end = _elm_community$elm_time$Time_DateTime$fromTuple(
		{ctor: '_Tuple7', _0: 2010, _1: 10, _2: 10, _3: 10, _4: 10, _5: 0, _6: 0});
	var start = _elm_community$elm_time$Time_DateTime$fromTuple(
		{ctor: '_Tuple7', _0: 2010, _1: 10, _2: 10, _3: 10, _4: 0, _5: 0, _6: 0});
	return A3(
		_user$project$Model$Activity,
		'foo',
		15,
		{
			ctor: '::',
			_0: A2(_user$project$Model$LogEntry, start, end),
			_1: {ctor: '[]'}
		});
}();
var _user$project$Model$initActivity2 = function () {
	var end = _elm_community$elm_time$Time_DateTime$fromTuple(
		{ctor: '_Tuple7', _0: 2010, _1: 10, _2: 10, _3: 10, _4: 10, _5: 0, _6: 0});
	var start = _elm_community$elm_time$Time_DateTime$fromTuple(
		{ctor: '_Tuple7', _0: 2010, _1: 10, _2: 10, _3: 10, _4: 0, _5: 0, _6: 0});
...
var _user$project$Model$initActivity3 = function () {
	var end = _elm_community$elm_time$Time_DateTime$fromTuple(
		{ctor: '_Tuple7', _0: 2010, _1: 10, _2: 10, _3: 10, _4: 10, _5: 0, _6: 0});
	var start = _elm_community$elm_time$Time_DateTime$fromTuple(
		{ctor: '_Tuple7', _0: 2010, _1: 10, _2: 10, _3: 10, _4: 0, _5: 0, _6: 0});
...
var _user$project$Model$initActivity4 = function () {
	var end = _elm_community$elm_time$Time_DateTime$fromTuple(
		{ctor: '_Tuple7', _0: 2010, _1: 10, _2: 10, _3: 10, _4: 10, _5: 0, _6: 0});
	var start = _elm_community$elm_time$Time_DateTime$fromTuple(
		{ctor: '_Tuple7', _0: 2010, _1: 10, _2: 10, _3: 10, _4: 0, _5: 0, _6: 0});
...
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {location: a, apiUrl: b, authenticatedData: c, errorMessage: d, activities: e, number: f};
	});
var _user$project$Model$Log = {ctor: 'Log'};
var _user$project$Model$Activities = {ctor: 'Activities'};
var _user$project$Model$Tomorrow = {ctor: 'Tomorrow'};
var _user$project$Model$Home = {ctor: 'Home'};
var _user$project$Model$route = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Model$Home, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Model$Tomorrow,
				_evancz$url_parser$UrlParser$s('tomorrow')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Model$Activities,
					_evancz$url_parser$UrlParser$s('activities')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Model$Log,
						_evancz$url_parser$UrlParser$s('log')),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$Model$init = F2(
	function (apiUrl, location) {
		return {
			ctor: '_Tuple2',
			_0: {
				location: A2(_evancz$url_parser$UrlParser$parsePath, _user$project$Model$route, location),
				apiUrl: apiUrl,
				authenticatedData: A3(_user$project$Model$AuthenticatedData, '', '', ''),
				errorMessage: '',
				activities: {
					ctor: '::',
					_0: _user$project$Model$initActivity1,
					_1: {
						ctor: '::',
						_0: _user$project$Model$initActivity2,
						_1: {
							ctor: '::',
							_0: _user$project$Model$initActivity3,
							_1: {
								ctor: '::',
								_0: _user$project$Model$initActivity4,
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Model$PostActivityResult = function (a) {
	return {ctor: 'PostActivityResult', _0: a};
};
var _user$project$Model$PostActivity = {ctor: 'PostActivity'};
var _user$project$Model$Decrement = {ctor: 'Decrement'};
var _user$project$Model$Increment = {ctor: 'Increment'};
...
var _user$project$Ports$authenticated = _elm_lang$core$Native_Platform.incomingPort(
	'authenticated',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (name) {
					...
					return A2(
						...
						function (id_token) {
							return _elm_lang$core$Json_Decode$succeed(
								{name: name, image_url: image_url, id_token: id_token});
						},
						A2(_elm_lang$core$Json_Decode$field, 'id_token', _elm_lang$core$Json_Decode$string));
				},
				A2(_elm_lang$core$Json_Decode$field, 'image_url', _elm_lang$core$Json_Decode$string));
		},
		A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string)));

var _user$project$Subscriptions$subscriptions = function (_p0) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Ports$authenticated(_user$project$Model$Authenticated),
			_1: {ctor: '[]'}
		});
};

var _user$project$Update$postActivity = function (apiUrl) {
	var body = A2(_elm_lang$http$Http$stringBody, 'application/json', '{ name: \'hallo\', minutesPerWeek: 15 }');
	var url = A2(_elm_lang$core$Basics_ops['++'], apiUrl, '/activities');
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Model$PostActivityResult,
		...
		switch (_p1.ctor) {
			...
			case 'UrlChange':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							location: A2(_evancz$url_parser$UrlParser$parsePath, _user$project$Model$route, _p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Increment':
			...
			case 'PostActivity':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Update$postActivity(model.apiUrl)
				};
			case 'PostActivityResult':
				if (_p1._0.ctor === 'Ok') {
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{authenticatedData: _p1._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});

var _user$project$View$activityView = function (activity) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('mdl-data-table__cell--non-numeric'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(activity.name),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							_user$project$Model$remainingString(activity)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_user$project$Model$onScheduleRatioString(activity)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$View$topActivitiesView = function (activities) {
	return A2(
		_elm_lang$html$Html$table,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
						...
						{ctor: '[]'},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Remaining'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('On schedule'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$View$activityView,
						_user$project$Model$topActivities(activities))),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$View$locationView = function (model) {
	var _p0 = model.location;
	if (_p0.ctor === 'Just') {
		switch (_p0._0.ctor) {
			case 'Home':
				return _user$project$View$topActivitiesView(model.activities);
			case 'Tomorrow':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Tomorrow'),
						_1: {ctor: '[]'}
					});
			case 'Activities':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Activities'),
						_1: {ctor: '[]'}
					});
			default:
				return A2(
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Unknown page'),
				_1: {ctor: '[]'}
			});
	}
};
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mdl-layout mdl-js-layout mdl-layout--fixed-drawer'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(model.authenticatedData.name),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
									...
									_0: A2(
										_elm_lang$html$Html$a,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Model$NewUrl('/tomorrow')),
												_1: {ctor: '[]'}
											}
										},
										{
										...
										_0: A2(
											_elm_lang$html$Html$a,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Model$NewUrl('/activities')),
													_1: {ctor: '[]'}
												}
											},
											{
											...
											_0: A2(
												_elm_lang$html$Html$a,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Model$NewUrl('/log')),
														_1: {ctor: '[]'}
													}
												},
												{
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('my-signin2'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Model$PostActivity),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Post activity'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _user$project$View$locationView(model),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _user$project$Main$main = A2(
	...
	{init: _user$project$Model$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$Subscriptions$subscriptions})(_elm_lang$core$Json_Decode$string);

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Model.Msg","aliases":{"Model.AuthenticatedData":{"type":"{ name : String, image_url : String, id_token : String }","args":[]},"Navigation.Location":{"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }","args":[]},"Http.Response":{"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }","args":["body"]}},"unions":{"Dict.NColor":{"tags":{"Black":[],"BBlack":[],"Red":[],"NBlack":[]},"args":[]},"Result.Result":{"tags":{"Err":["error"],"Ok":["value"]},"args":["error","value"]},"Http.Error":{"tags":{"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"],"BadUrl":["String"],"NetworkError":[]},"args":[]},"Dict.LeafColor":{"tags":{"LBlack":[],"LBBlack":[]},"args":[]},"Model.Msg":{"tags":{"PostActivityResult":["Result.Result Http.Error ()"],"NewUrl":["String"],"UrlChange":["Navigation.Location"],"PostActivity":[],"Authenticated":["Model.AuthenticatedData"],"Increment":[],"Decrement":[]},"args":[]},"Dict.Dict":{"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]},"args":["k","v"]}}},"versions":{"elm":"0.18.0"}});
}
